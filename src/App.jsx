...
// ─── FULL PRODUCT LIST (from price sheet, GR Price) ───────────────────────────
// qty starts at 0 — you fill these in
const SEED_ITEMS = [
  // BERRIES
  { id:101, cat:"Berries",     name:"Blackberries",          price:7.00, unit:"lb",     freshnessType:"berry",        emoji:"🫐", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:102, cat:"Berries",     name:"Blueberries",           price:6.67, unit:"lb",     freshnessType:"berry",        emoji:"🫐", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:103, cat:"Berries",     name:"Strawberries",          price:7.00, unit:"lb",     freshnessType:"berry",        emoji:"🍓", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:104, cat:"Berries",     name:"u-pic Blueberries",     price:28.00,unit:"gallon", freshnessType:"berry",        emoji:"🫐", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  // GREENS
  { id:201, cat:"Greens",      name:"Arugula",               price:10.00,unit:"lb",     freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:202, cat:"Greens",      name:"Spinach",               price:20.00,unit:"lb",     freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:203, cat:"Greens",      name:"Dino Kale",             price:4.00, unit:"bundle", freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:204, cat:"Greens",      name:"Siberian Kale",         price:4.00, unit:"bundle", freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:205, cat:"Greens",      name:"Red Russian Kale",      price:4.00, unit:"bundle", freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:206, cat:"Greens",      name:"Swiss Chard",           price:4.00, unit:"bundle", freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:207, cat:"Greens",      name:"Romaine Lettuce",       price:3.00, unit:"bundle", freshnessType:"lettuce",      emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:208, cat:"Greens",      name:"Salanova Lettuce Mix",  price:6.00, unit:"lb",     freshnessType:"lettuce",      emoji:"🥗", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:209, cat:"Greens",      name:"Mustard Greens",        price:4.00, unit:"bundle", freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:210, cat:"Greens",      name:"Collard Greens",        price:4.00, unit:"lb",     freshnessType:"greens",       emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  // VEGETABLES
  { id:301, cat:"Vegetables",  name:"Beets",                 price:4.00, unit:"lb",     freshnessType:"roots",        emoji:"🫀", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:302, cat:"Vegetables",  name:"Broccoli",              price:8.00, unit:"lb",     freshnessType:"brassicas",    emoji:"🥦", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:303, cat:"Vegetables",  name:"Cabbage",               price:1.00, unit:"lb",     freshnessType:"brassicas",    emoji:"🥬", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:304, cat:"Vegetables",  name:"Carrots",               price:5.00, unit:"pound",  freshnessType:"roots",        emoji:"🥕", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:305, cat:"Vegetables",  name:"Cucumbers / English",   price:2.00, unit:"lb",     freshnessType:"fruiting",     emoji:"🥒", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:306, cat:"Vegetables",  name:"Eggplant",              price:3.00, unit:"lb",     freshnessType:"fruiting",     emoji:"🍆", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:307, cat:"Vegetables",  name:"Salad Turnips",         price:4.00, unit:"lb",     freshnessType:"roots",        emoji:"🟣", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:308, cat:"Vegetables",  name:"Kohlrabi",              price:3.00, unit:"lb",     freshnessType:"brassicas",    emoji:"🫑", qty:0, harvestedOn:"", publicVisible:false, orderable:false },
  { id:309, cat:"Vegetables",  name:"Radishes",              price:2.00, unit:"lb",     freshnessType:"roots",        emoji:"🔴", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:310, cat:"Vegetables",  name:"Yellow Squash",         price:3.00, unit:"lb",     freshnessType:"squash",       emoji:"🟡", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:311, cat:"Vegetables",  name:"Zucchini",              price:3.00, unit:"lb",     freshnessType:"squash",       emoji:"🥒", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:312, cat:"Vegetables",  name:"Green Onions",          price:4.00, unit:"lb",     freshnessType:"alliums",      emoji:"🌱", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:313, cat:"Vegetables",  name:"Leeks",                 price:1.00, unit:"each",   freshnessType:"alliums",      emoji:"🌿", qty:0, harvestedOn:"", publicVisible:false, orderable:false },
  { id:314, cat:"Vegetables",  name:"Potatoes",              price:2.00, unit:"lb",     freshnessType:"roots",        emoji:"🥔", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:315, cat:"Vegetables",  name:"Purple Top Turnips",    price:4.00, unit:"lb",     freshnessType:"roots",        emoji:"🟣", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:316, cat:"Vegetables",  name:"Green Beans",           price:8.00, unit:"lb",     freshnessType:"legumes",      emoji:"🫘", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:317, cat:"Vegetables",  name:"Okra",                  price:3.00, unit:"lb",     freshnessType:"fruiting",     emoji:"🫘", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:318, cat:"Vegetables",  name:"Okra Sliced",           price:5.00, unit:"lb",     freshnessType:"fruiting",     emoji:"🫘", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:319, cat:"Vegetables",  name:"Sugar Snap Peas",       price:8.00, unit:"lb",     freshnessType:"legumes",      emoji:"🫛", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  // PEPPERS
  { id:401, cat:"Peppers",     name:"Anaheim / Chili Peppers",price:4.00,unit:"lb",     freshnessType:"peppers",      emoji:"🌶️", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:402, cat:"Peppers",     name:"Bell Peppers",          price:4.00, unit:"lb",     freshnessType:"peppers",      emoji:"🫑", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:403, cat:"Peppers",     name:"Jalapeños",             price:4.00, unit:"lb",     freshnessType:"peppers",      emoji:"🌶️", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:404, cat:"Peppers",     name:"Habanero",              price:7.00, unit:"lb",     freshnessType:"peppers",      emoji:"🌶️", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:405, cat:"Peppers",     name:"Banana Peppers",        price:4.00, unit:"lb",     freshnessType:"peppers",      emoji:"🫑", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  // TOMATOES
  { id:501, cat:"Tomatoes",    name:"Cherry Tomatoes",       price:4.00, unit:"pint",   freshnessType:"tomatoes",     emoji:"🍒", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:502, cat:"Tomatoes",    name:"Tomatoes Large",        price:4.00, unit:"lb",     freshnessType:"tomatoes",     emoji:"🍅", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  // HERBS
  { id:601, cat:"Herbs",       name:"Basil",                 price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:602, cat:"Herbs",       name:"Cilantro",              price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:603, cat:"Herbs",       name:"Dill",                  price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:604, cat:"Herbs",       name:"Parsley",               price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:605, cat:"Herbs",       name:"Rosemary",              price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:606, cat:"Herbs",       name:"Mint",                  price:3.00, unit:"bundle", freshnessType:"herbs",        emoji:"🌿", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  { id:607, cat:"Herbs",       name:"Flowers",               price:8.00, unit:"bunch",  freshnessType:"flowers",      emoji:"🌸", qty:0, harvestedOn:"", publicVisible:true,  orderable:false },
  // CANNED GOODS
  { id:701, cat:"Canned Goods",name:"Bread & Butter Pickles",price:10.00,unit:"pt",     freshnessType:"pickled",      emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:702, cat:"Canned Goods",name:"Candied Jalapeños",     price:12.00,unit:"pt",     freshnessType:"pickled",      emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:703, cat:"Canned Goods",name:"Pickled Cabbage",       price:10.00,unit:"pt",     freshnessType:"pickled",      emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:704, cat:"Canned Goods",name:"Pickled Okra",          price:10.00,unit:"pt",     freshnessType:"pickled",      emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:705, cat:"Canned Goods",name:"Hot-n-Spicy Pickled Okra",price:10.00,unit:"pt",  freshnessType:"pickled",      emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:706, cat:"Canned Goods",name:"Salsa",                 price:10.00,unit:"pt",     freshnessType:"canned",       emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:707, cat:"Canned Goods",name:"Hot Salsa",             price:10.00,unit:"pt",     freshnessType:"canned",       emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:708, cat:"Canned Goods",name:"Jalapeño Blueberry Jam",price:10.00,unit:"half pt",freshnessType:"jam",          emoji:"🫙", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  // REFRIGERATOR
  { id:801, cat:"Refrigerator",name:"Fresh Cucumber Pickles",price:10.00,unit:"pt",     freshnessType:"refrigerated", emoji:"🥒", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
  { id:802, cat:"Refrigerator",name:"Purple Hull Peas",      price:9.00, unit:"pt",     freshnessType:"refrigerated", emoji:"🫛", qty:0, harvestedOn:"", publicVisible:true,  orderable:true  },
];
...
const ALL_CATS = ["All","Berries","Greens","Vegetables","Peppers","Tomatoes","Herbs","Canned Goods","Refrigerator"];
...
export default function App() {
  const [items, setItems]       = useState(() => load("grf_items", SEED_ITEMS));
  const [settings, setSettings] = useState(() => load("grf_settings", SEED_SETTINGS));
  const [orders, setOrders]     = useState(() => load("grf_orders", []));
  const [marketPlan, setMarketPlan] = useState(() => load("grf_market_plan", {}));
  const [isAdmin, setIsAdmin]   = useState(false);
  const [tab, setTab]           = useState("stock");
  const [showLogin, setShowLogin] = useState(false);

  useEffect(() => save("grf_items",       items),      [items]);
  useEffect(() => save("grf_settings",    settings),   [settings]);
  useEffect(() => save("grf_orders",      orders),     [orders]);
  useEffect(() => save("grf_market_plan", marketPlan), [marketPlan]);
    ...
    <div style={{fontFamily:"'Lora',Georgia,serif",background:"#f5f2ed",minHeight:"100vh",maxWidth:580,margin:"0 auto"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .modal{background:#fff;border-radius:22px 22px 0 0;padding:26px 22px 40px;width:100%;max-width:580px;max-height:92vh;overflow-y:auto;}
        ...
        .need-harvest{background:#fff8ee;border:1px solid #f0c060;border-radius:8px;padding:6px 10px;font-family:'JetBrains Mono',monospace;font-size:11px;color:#7c4a08;}
        .good-stock{background:#f0fae8;border:1px solid #9dd87a;border-radius:8px;padding:6px 10px;font-family:'JetBrains Mono',monospace;font-size:11px;color:#1a5a0a;}
        ...
        .chip{display:inline-flex;align-items:center;gap:4px;background:#f0ebe2;border-radius:6px;padding:4px 10px;font-family:'JetBrains Mono',monospace;font-size:11px;color:#5a4a32;white-space:nowrap;}
        .harvest-needed{color:#a05008;font-weight:600;}
      `}</style>
      ...
      <div className="content">
        ...
        {tab==="market"  && <MarketTab  items={items} updateItem={updateItem} marketPlan={marketPlan} setMarketPlan={setMarketPlan} isAdmin={isAdmin} />}
        {tab==="log"     && <LogTab     items={items} updateItem={updateItem} />}
    ...
    <div className="fade">
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:4,marginBottom:4}}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <button className="btn btn-ghost btn-sm" onClick={()=>setShowZero(s=>!s)} style={{fontSize:10}}>
      ...
      {aging.length>0 && (
        <div className="warn-bar" style={{margin:"12px 0"}}>
          <span>⚠️</span>
            ...
            <div key={item.id} className="card" style={{padding:"13px 14px",opacity:item.qty===0?0.45:1}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:item.qty>0?8:0}}>
                <div style={{display:"flex",alignItems:"center",gap:9}}>
                  ...
                  <div>
                    <div style={{fontWeight:600,fontSize:14,color:"#1a1208"}}>{item.name}</div>
                    <div style={{display:"flex",gap:6,marginTop:2,alignItems:"center"}}>
                      <span className="mono" style={{fontSize:10,color:"#9a8a72"}}>${item.price}/{item.unit}</span>
                ...
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  <div style={{flex:1}}>
                    <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                      <span className="mono" style={{fontSize:12,color:item.qty<=3?"#a05008":"#1a4a0a",fontWeight:600}}>{item.qty} {item.unit}</span>
              ...
              {/* Empty item — quick add */}
              {item.qty === 0 && isAdmin && (
                <button className="btn btn-ghost btn-sm" style={{marginTop:8,fontSize:10,width:"100%"}} onClick={()=>setEditItem(item)}>
                  + Set quantity & date
                </button>
              )}
            </div>
      ...
      {editItem && isAdmin && (
        <EditItemModal item={editItem} onSave={p=>{updateItem(editItem.id,p);setEditItem(null);}} onDelete={()=>{setItems(is=>is.filter(i=>i.id!==editItem.id));setEditItem(null);}} onClose={()=>setEditItem(null)} />
      )}
      {showAdd && isAdmin && (
        <AddItemModal onAdd={n=>{setItems(is=>[...is,{...n,id:Date.now()}]);setShowAdd(false);}} onClose={()=>setShowAdd(false)} />
      )}
    </div>
  );
}
...
// ─── MARKET TAB ───────────────────────────────────────────────────────────────
function MarketTab({ items, updateItem, marketPlan, setMarketPlan, isAdmin }) {
  const [view, setView]   = useState("plan"); // plan | closeout | done
  const [returns, setReturns] = useState({});

  // marketPlan: { [itemId]: { wantQty: number } }
  ...
  // Harvest needed = want - current stock (if want > stock)
  ...
  if (view==="done") return (
    <div className="fade" style={{textAlign:"center",paddingTop:60}}>
      ...
      <h2 style={{fontSize:22,fontWeight:700,color:"#1a4a0a",marginBottom:8}}>Market Day Closed!</h2>
  ...
  return (
    <div className="fade">
      ...
      {view==="plan" && (
        <div>
          <p style={{fontSize:13,color:"#6a5a42",marginBottom:14,lineHeight:1.6}}>
            Set how much of each item you want to bring. We'll tell you what you already have and what still needs to be harvested.
          </p>
          ...
          {totalHarvestItems > 0 && (
            <div className="warn-bar" style={{marginBottom:14}}>
              <span>🌾</span>
              <div>
                <div className="mono" style={{fontSize:11,color:"#713f12",marginBottom:4}}>HARVEST NEEDED BEFORE MARKET:</div>
                {planned.filter(([id])=>harvestNeeded(id)>0).map(([id,plan])=>{
                  const item = items.find(i=>i.id===parseInt(id));
                  if(!item) return null;
                  return <div key={id} className="mono" style={{fontSize:11,color:"#a05008"}}>· {item.name} — need {harvestNeeded(id)} more {item.unit}</div>;
                })}
              </div>
            </div>
          )}
            ...
            {items.map(item => {
              ...
              return (
                <div key={item.id} className="card" style={{padding:"12px 14px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:10,marginBottom: plan>0?10:0}}>
                    <span style={{fontSize:22}}>{item.emoji}</span>
                    <div style={{flex:1}}>
                      <div style={{fontWeight:600,fontSize:13}}>{item.name}</div>
                      <div className="mono" style={{fontSize:10,color:"#9a8a72"}}>${item.price}/{item.unit} · {have} in stock</div>
                    </div>
                    <input
                      type="number" inputMode="numeric"
                      value={plan||""}
                      onChange={e=>setPlanQty(item.id, e.target.value)}
                      placeholder="0"
                      style={{width:60,textAlign:"center",padding:"8px 6px",fontSize:14}}
                    />
                  </div>
                  {plan > 0 && (
                    <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                      {need === 0
                        ? <span className="good-stock">✅ {have} in stock — ready to pack</span>
                        : <span className="need-harvest">🌾 Need to harvest {need} more {item.unit}</span>
                      }
                    </div>
                  )}
                </div>
          ...
          {/* Summary */}
          {planned.length > 0 && (
            <div className="card" style={{padding:16,marginTop:16,background:"#f0fae8",border:"1px solid #9dd87a"}}>
              <div className="stitle" style={{color:"#1a4a0a",marginBottom:10}}>Market Load Summary</div>
              {planned.map(([id,plan])=>{
                const item = items.find(i=>i.id===parseInt(id));
                if(!item) return null;
                const need = harvestNeeded(parseInt(id));
                return (
                  <div key={id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:7}}>
                    <span style={{fontSize:13}}>{item.emoji} {item.name}</span>
                    <div style={{display:"flex",gap:8,alignItems:"center"}}>
                      <span className="mono" style={{fontSize:12,color:"#1a4a0a",fontWeight:600}}>{plan.wantQty} {item.unit}</span>
                      {need>0 && <span className="mono" style={{fontSize:10,color:"#a05008"}}>harvest {need}</span>}
                    </div>
                  </div>
                );
              })}
              <div style={{borderTop:"1px solid #b8e098",marginTop:10,paddingTop:10}}>
                <div className="mono" style={{fontSize:11,color:"#1a4a0a"}}>
                  {planned.length} items · ${planned.reduce((s,[id,p])=>{
                    const item=items.find(i=>i.id===parseInt(id));
                    return s+(item?item.price*p.wantQty:0);
                  },0).toFixed(0)} potential revenue
                </div>
              </div>
            </div>
          )}
      ...
      {view==="closeout" && (
        <div>
          {planned.length===0 ? (
            <div style={{textAlign:"center",paddingTop:40,color:"#9a8a72"}}>
              <p className="mono" style={{fontSize:12}}>No market plan set yet.</p>
              <p className="mono" style={{fontSize:11,marginTop:6}}>Go to Plan Load first.</p>
            </div>
          ) : (
            <>
              <p style={{fontSize:13,color:"#6a5a42",marginBottom:14}}>Enter what came back. Sold = Planned − Returned. Inventory auto-updates.</p>
                  ...
                  return (
                    <div key={id} className="card" style={{padding:"12px 14px"}}>
                      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
                        ...
                        <div style={{flex:1}}>
                          <div style={{fontWeight:600,fontSize:13}}>{item.name}</div>
                          <div className="mono" style={{fontSize:10,color:"#9a8a72"}}>Planned: {plan.wantQty} {item.unit}</div>
                        </div>
...
// ─── LOG TAB ─────────────────────────────────────────────────────────────────
function LogTab({ items, updateItem }) {
  ...
  const submit = () => {
    ...
    if (mode==="picked") updateItem(sel.id,{qty:sel.qty+n,harvestedOn:date});
    else updateItem(sel.id,{qty:Math.max(0,sel.qty-n)});
    setDone(true);
    setTimeout(()=>{setMode(null);setSel(null);setQty("");setDone(false);},1800);
  };
  ...
  if (done) return (
    <div className="fade" style={{textAlign:"center",paddingTop:80}}>
      ...
      <p className="mono" style={{fontSize:12,color:"#9a8a72"}}>{qty} {sel?.unit} · {sel?.name}</p>
    </div>
  );
  ...
  return (
    <div className="fade">
      ...
      <p className="mono" style={{fontSize:11,color:"#9a8a72",marginBottom:18}}>QUICK ENTRY · 3 TAPS</p>
      ...
      {mode&&!sel&&(
        <div>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
            ...
            <span style={{fontWeight:700,fontSize:15}}>{mode==="picked"?"What was picked?":"What from the fridge?"}</span>
          </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:9}}>
            {filtered.map(i=>(
              <div key={i.id} className="bigbtn" style={{padding:13}} onClick={()=>setSel(i)}>
                ...
                <div className="mono" style={{fontSize:10,color:"#9a8a72"}}>{i.qty} {i.unit}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {mode&&sel&&(
        <div>
          ...
          <div className="card" style={{padding:18,marginBottom:12}}>
            <div className="mono" style={{fontSize:11,color:"#9a8a72",marginBottom:8}}>HOW MANY {sel.unit.toUpperCase()}S?</div>
            <input type="number" inputMode="numeric" value={qty} onChange={e=>setQty(e.target.value)} placeholder="0" style={{fontSize:30,textAlign:"center",padding:12}} autoFocus />
            <div style={{display:"flex",gap:7,marginTop:10,flexWrap:"wrap"}}>
              {[1,2,5,10,12,24,50].map(n=>(
                <button key={n} className="btn btn-ghost btn-sm" onClick={()=>setQty(String(n))}>{n}</button>
              ))}
            </div>
          </div>
          {mode==="picked"&&(
          ...
          <button className="btn btn-green" style={{width:"100%",padding:15,fontSize:14}} onClick={submit} disabled={!qty}>
...
function PublicTab({ items, updateItem, orders, setOrders, settings, setSettings, isAdmin }) {
  ...
  const placeOrder = () => {
    const lines = Object.entries(form.cart).filter(([,q])=>q>0).map(([id,qty])=>{
      const item = items.find(i=>i.id===parseInt(id));
      return {id:parseInt(id),name:item?.name,qty,unit:item?.unit,price:item?.price};
    });
  ...
  return (
    <div className="fade">
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:4,marginBottom:4}}>
        ...
        {isAdmin&&<button className="btn btn-ghost btn-sm" onClick={()=>setShowSettings(true)}>⚙️</button>}
      </div>
      <p className="mono" style={{fontSize:11,color:"#9a8a72",marginBottom:14}}>WEBSITE VISIBILITY · PRE-ORDERS</p>
      ...
      {view==="availability"&&(
        <div>
          {isAdmin&&<div style={{background:"#f0fae8",border:"1px solid #9dd87a",borderRadius:10,padding:"9px 13px",marginBottom:12}}><span className="mono" style={{fontSize:11,color:"#1a4a0a"}}>🔓 Admin: toggle visibility & ordering per item</span></div>}
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {items.map(i=>(
              <div key={i.id} className="card" style={{padding:"11px 13px",display:"flex",alignItems:"center",gap:10,opacity:i.publicVisible?1:0.45}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{display:"flex",gap:6,marginTop:2,flexWrap:"wrap"}}>
                    <span className="mono" style={{fontSize:10,color:"#9a8a72"}}>${i.price}/{i.unit}</span>
                    <span className="mono" style={{fontSize:10,color:"#9a8a72"}}>· {i.qty} left</span>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:11}}>
              ...
              {orderable.map(i=>(
                <div key={i.id} className="card" style={{padding:"11px 13px",display:"flex",alignItems:"center",gap:10}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{fontWeight:600,fontSize:13}}>{i.name}</div>
                    <div className="mono" style={{fontSize:10,color:"#9a8a72"}}>${i.price}/{i.unit}</div>
                  </div>
                  <div style={{display:"flex",alignItems:"center",gap:7}}>
              ...
              <textarea rows={2} placeholder="Notes or special requests" value={form.notes} onChange={e=>setForm(f=>({...f,notes:e.target.value}))} />
            ...
            <div key={o.id} className="card" style={{padding:14,marginBottom:10}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:9}}>
                ...
                <div style={{display:"flex",gap:7}}>
                  <button className="btn btn-green btn-sm" style={{background:o.status==="confirmed"?"#14420a":"#1a4a0a"}} onClick={()=>setOrders(os=>os.map(x=>x.id===o.id?{...x,status:"confirmed"}:x))}>
      ...
      <div className="modal fade">
        ...
        <div style={{display:"flex",flexDirection:"column",gap:11}}>
          ...
          <div style={{display:"flex",gap:9}}>
            ...
            <input value={f.unit} onChange={e=>s("unit",e.target.value)} placeholder="Unit" />
          </div>
          <div style={{display:"flex",gap:9}}>
...
function AddItemModal({onAdd,onClose}){
  const [f,setF]=useState({name:"",emoji:"🌱",cat:"Greens",freshnessType:"greens",qty:0,unit:"bunch",price:0,harvestedOn:"",publicVisible:true,orderable:false});
  const s=(k,v)=>setF(x=>({...x,[k]:v}));
  return(
    <div className="modal-bg" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal fade">
      ...
      <div className="modal fade">
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          {[
            ...
            {k:"phone",         label:"CONTACT PHONE",   ph:"(337) 529-6761"},
          ].map(({k,label,ph})=>(
            <div key={k}>
